...
function ModulesSection() {
  ...
  return (
    <section id="modules" aria-label="Project modules" className="bg-white/[0.02]">
...
function CodingActivitySection() {
  return (
    <section id="coding-activity" aria-label="Coding activity" className="px-4 md:px-8 py-16 border-t border-border">

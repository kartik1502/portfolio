...
export function AboutContent() {
  return (
    <>
      ...
      <section id="experience" aria-label="Work experience" className="px-4 md:px-8 py-20 border-b border-border">
      ...
      <section id="proficiency" aria-label="Skill proficiency" className="px-4 md:px-8 py-20 border-b border-border">
        <div className="grid grid-cols-4 md:grid-cols-12 gap-6">
          <div className="col-span-4 md:col-span-3">
            <h2 className="font-display text-xs font-bold uppercase tracking-[0.3em] text-primary">
              Proficiency.chart
      ...
      <section id="credentials" aria-label="Certifications" className="px-4 md:px-8 py-20">
        <div className="grid grid-cols-4 md:grid-cols-12 gap-6">
          <div className="col-span-4 md:col-span-3">
            <h2 className="font-display text-xs font-bold uppercase tracking-[0.3em] text-primary">
              Credentials
